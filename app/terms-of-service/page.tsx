    ...
    <>
      <div className="max-w-4xl mx-auto p-6 space-y-8 text-gray-700">
        ...
        <section>
          ...
          <p>
            Welcome to WanderAI! These Terms of Service (“Terms”) govern your use of our AI-powered
        ...
        <section>
          ...
          <p>
            To use WanderAI, you must be at least 18 years old or the age of majority in your
        ...
        <section>
          ...
          <p>
            To access certain features of WanderAI, you may need to create an account using Clerk
        ...
        <section>
          ...
          <p>
            WanderAI grants you a limited, non-exclusive, non-transferable, and revocable license to
            use our services for personal, non-commercial purposes. You agree not to:
          </p>
        ...
        <section>
          ...
          <p>
            Certain features of WanderAI may require a subscription or one-time payment. You agree
        ...
        <section>
          ...
          <p>
            WanderAI and its content, including but not limited to text, graphics, logos, and
            software, are the property of WanderAI and protected by intellectual property laws. You
        ...
        <section>
          ...
          <p>
            WanderAI is provided “as is” without warranties of any kind. We do not guarantee the
            accuracy or completeness of the information provided. To the maximum extent permitted by
            law, WanderAI is not liable for any indirect, incidental, or consequential damages
        ...
        <section>
          ...
          <p>
            We reserve the right to suspend or terminate your account or access to WanderAI at any
        ...
        <section>
          ...
          <p>
            These Terms are governed by the laws of the jurisdiction in which WanderAI operates. Any
            disputes arising from these Terms or your use of the service will be subject to the
        ...
        <section>
          ...
          <p>
            ...
            periodically. Your continued use of WanderAI following any changes constitutes
        ...
        <section>
          ...
          <p>
            If you have any questions about these Terms, please contact us at support@wanderai.com.
          </p>
        </section>
      </div>
      <Footer />
